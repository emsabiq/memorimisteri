...
Use claude-mem only as orientation. Before production-facing changes, verify the current files, env defaults, provider settings, generated output paths, and any deploy or workflow target.
